# ============================================================
# Experimento 33 — CNN pura con género
# Réplica de exp 31 con código corregido (fusión con USE_GENDER)
# Comparar contra exp 34 (densenet121) para evaluar backbone vs CNN
# ============================================================
