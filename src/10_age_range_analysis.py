...
def segment_crop_bbox(img, seg_model, segments_order, padding_ratio=0.15):
...
def get_segments(img, seg_model, segments_order, cfg):
    ...
    if getattr(cfg, "SEGMENT_MODE", "spatial") == "cropped":
        ...
        return segment_crop_bbox(img, seg_model, segments_order, padding_ratio=padding)
    return segment_spatial(img, seg_model, segments_order)
