# ============================================================
# Experimento 39 — CNN pura con género, dataset balanceado
# Réplica de exp 33 usando balanced_dataset.csv (11,783 imgs · 36 edades).
# Solo edades con ≥50 muestras. Comparar contra exp 33 (raw) y exp 36 (completo).
# ============================================================
