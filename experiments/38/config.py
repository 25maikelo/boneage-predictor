# ============================================================
# Experimento 38 — DenseNet121 vectores de características con género, dataset completo
# Réplica del diseño de exp 35 (backbone_vectors) sin filtro de edad mínima.
# Usa las 12,611 imágenes con las 160 clases de edad (1–228 m).
# Comparar contra exp 35 (dataset balanceado) y exp 37 (mismo dataset, fusión escalar).
# ============================================================
