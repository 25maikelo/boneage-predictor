# ============================================================
# Experimento 49 — backbone, LR bajo + pocas épocas de fusión
# Base: Exp 37 (backbone, completo, LR=1e-3, FUSION_EPOCHS=20)
# Variable cambiada: LEARNING_RATE=1e-4, FUSION_EPOCHS=10
# Pregunta: ¿LR más conservador con menos épocas mejora la fusión?
# Comparar contra Exp 37 y Exp 50 (extremo opuesto)
# ============================================================
